...
const CAT_BG: Record<string, string> = {
  fact: "rgba(74,158,255,0.15)",
  decision: "rgba(168,85,247,0.15)",
  conversation: "rgba(0,212,170,0.15)",
  task: "rgba(245,158,11,0.15)",
  lesson: "rgba(16,185,129,0.15)",
  preference: "rgba(236,72,153,0.15)",
  procedure: "rgba(34,211,238,0.15)",
  signal: "rgba(255,65,54,0.15)",
};
  ...
  if (data === null) {
    return (
      ...
      >
        ...
        >
          <p style={{ color: "#FF4136", marginBottom: 4 }}>Room not found</p>
          <p style={{ fontSize: 13 }}>It may have been removed or the link is invalid.</p>
        </div>
      </div>
    );
  }
    ...
    >
      ...
      >
        <div style={{ minWidth: 0, flex: "1 1 300px" }}>
          ...
          {room.summary && (
            <p style={{ color: "#888", maxWidth: 600, fontSize: 14, lineHeight: 1.55 }}>
              {room.summary}
            </p>
          )}
        </div>
      ...
      {closets.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {closets.map((c: any, i: number) => {
            ...
            const long = c.content.length > 500;
            return (
              <div
                key={c.id}
                className="anim-in"
              ...
              >
                ...
                {c.title && (
                  <h4 style={{ fontSize: 14, fontWeight: 600, marginBottom: 6 }}>{c.title}</h4>
                )}
                <p
                  style={{
                    color: "#B0B0B0",
                ...
                >
                  {long && !isExpanded ? c.content.slice(0, 500) + "…" : c.content}
                </p>
                {long && (
                  <button
